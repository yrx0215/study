...
public class LessionController {
    ...
    public Response<Lesson> selectAllLesson(){
    ...
    public Response<Long> addLesson(Lesson lesson, Long subjectId, Long courseId){
    ...
    public Response<Lesson> selectLessonById(Long lessonId){
        Lesson lesson = new Lesson();
    ...
    public Response<Lesson> updateLessonById(Long lessonId, Lesson lesson){
